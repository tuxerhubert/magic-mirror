...
var rssFeed = {
  ...
  feeds: [                          // rss feeds
    ...
    "http://www.nachrichten.at/storage/rss/rss/innviertel.xml"
  ]
}
receivedFeeds: 0,
allFeeds: [],
/**
 * update feeds into mirror
 */
update: function() {
  if (rssFeed.config.feeds.length == rssFeed.receivedFeeds) {
    rssFeed.allFeeds.forEach() //TODO
